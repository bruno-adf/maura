...
function Home() {
  ...
  return (
    <div className='home-container'>
        ...
        <div className='hero'>
            <div className='hero-containerA'>
                <h1 className='easeinleft' style={{'color':'var(--blueColor)'}}>Maura Cristiani<br/>de Moura</h1>
            ...
            <div className='hero-containerB'>
                <img className='image' src={maura1} alt="" />
        ...
        <div className='about'>
            ...
            <div className='about-containerB'>
                <div className='about-containerBA'>
                    <img className='image' src={maura2} alt="" />
                </div>
                <div className='about-containerBB'>
